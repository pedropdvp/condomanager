...
/**
 * Dados para criar uma fração. A fração pertence a um edifício de um condomínio do tenant.
 */
public record FracaoCreateDTO(

        @NotNull(message = "O condomínio é obrigatório")
        Long condominioId,

        @NotNull(message = "O edifício é obrigatório")
        Long edificioId,
